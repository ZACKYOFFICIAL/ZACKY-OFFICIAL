...
display_welcome() {
  ...
  echo -e "${YELLOW}[+]                  © zackyyofficiaL                    [+]${NC}"
  echo -e "${YELLOW}[+]                                                 [+]${NC}"
  echo -e "${YELLOW}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e "${RED}[+]               KUNCI BY OM                     [+]${NC}"
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "zackyyofficiaL" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu wkww Ke zackyyofficiaL Telegram @zackyyofficiaL${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/ZACKYOFFICIAL/ZACKY-OFFICIAL/raw/main/C2.zip")
        break
        ;;
      2)
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/ZACKYOFFICIAL/ZACKY-OFFICIAL/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/ZACKYOFFICIAL/ZACKY-OFFICIAL/raw/main/C2.zip
...
while true; do
  ...
  echo -e "                                                       "
echo -e "${RED}╔╦╦╦╦╦╦╦╦╦╦╗                                 ${NC}"
echo -e "${RED}╠╬╬╬╬╬╬╬╬╬╬╣     Auto installer :Zackyy OfficiaL ${NC}"
echo -e "${RED}╠╬╬█╬╬╬╬█╬╬╣       =======================   ${NC}"
echo -e "${RED}╠╬╬╬╬╬╬╬╬╬╬╣        By: ZackyyOfficiaL         ${NC}"
echo -e "${RED}╠╬████████╬╣         Tele : t.me/zackyyOfficiaL ${NC}"
echo -e "${RED}╠╬█╬╬╬╬╬╬█╬╣         YT: zackyyofficiaL        ${NC}"
echo -e "${RED}╚╩╩╩╩╩╩╩╩╩╩╝                                 ${NC}"
  echo -e "                                                       "
